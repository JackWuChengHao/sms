...
public class utils {
    ...
    public static  SendSmsResponse  sendSms(final String telephone,final String appeal_name,final String appeal_time) throws ClientException {
        ...
        String value = new StringBuilder("{\"appeal_name\":\"").append(appeal_name).append("\",\"appeal_time\":\"").append(appeal_time).append("\"}").toString();
